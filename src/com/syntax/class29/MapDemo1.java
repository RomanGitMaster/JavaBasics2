...
public class MapDemo1 {
    public static void main(String[] args) {
        ...
        System.out.println(fruit.get("Kiwi"));// we getting the value by key
        ...
        System.out.println(fruit.isEmpty());// checks if there any elements( keys in fruit)
        fruit.replace("Kiwi",5.2);// we replacing the value for the key "Kiwi"
        System.out.println(fruit);
